...
export default function SignInPage() {
  ...
  // Placeholder for future Supabase social auth
    ...
    <div className={styles.container}>
          ...
          <>
            <div className={styles.box} style={{marginTop: '3rem'}}>
              ...
              <Link
                to="/discovery"
                className={styles.switchSignInScreen}
                style={{ marginBottom: '0rem', marginTop: '0.25rem' }}
              >
                Back to Discovery
              </Link>
            </div>       
        ...
        {isSignUp && (
          <div className={styles.box}>
            ...
            <div className={styles.boxLabel} style={{fontSize: '1.5rem'}}>Sign Up with Social Account</div>
              ...
              <div className={styles.socialButtons}>
                ...
                <button type="button" className={`${styles.socialBtn} ${styles.google}`} onClick={() => handleSocial('Apple')}>
                  <img src={appleIcon} alt="Google logo" style={{ width: '28px', height: '28px'}} />
                </button>

                <button type="button" className={`${styles.socialBtn} ${styles.google}`} onClick={() => handleSocial('LinkedIn')}>
                  <img src={linkedInIcon} alt="Google logo" style={{ width: '36px', height: '36px'}} />
                </button>

                <button type="button" className={`${styles.socialBtn} ${styles.google}`} onClick={() => handleSocial('Spotify')}>
                  <img src={spotifyIcon} alt="Google logo" style={{ width: '28px', height: '28px'}} />
                </button>
              </div>
