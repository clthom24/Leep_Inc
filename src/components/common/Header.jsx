    ...
    <header className="site-header" style={{backgroundColor: '#15181c', width: '100%', overflowX: 'unset'}}>
      <div className="header-inner" style={{maxWidth: '100%', paddingBottom: '4px', paddingTop: '4px', marginLeft: '0.5vw', marginRight: '0px', gap: '14vw'}}>
        ...
        <Link to={homePath} className="brand" aria-label="Leep Audio home">
          <img src={logo} style={{height: '56px', width: '56px'}} alt="Leep Audio logo" className="logo-img" />
          <span className="brand-name" style={{fontSize: '19px'}}>Leep Audio</span>
        </Link>

        <span style={{width: '100%', display: 'flex', alignItems: 'center'}}>

          {/* Search Bar */}
          <form className="search-form" onSubmit={handleSearch} style={{paddingRight: '14px'}}>
            <input
              name="q"
              ...
              style={{height: '40px'}}
            />
            <button className="icon-button" type="submit" aria-label="Search" style={{height: '40px', width: '40px'}}>
          ...
          <nav className="user-nav" aria-label="Header navigation">
            {showAsSignedOut ? (
              ...
              <>
                <Link to={profilePath} className="icon-button" aria-label="Profile" style={{height: '40px', width: '40px'}}>
                ...
                <Link to="/contact" className="icon-button" aria-label="Contact" style={{height: '40px', width: '40px'}}>
