      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          {contactMethods.map((method, index) => (
            <div key={index} className={`${styles.cardBase} text-center`}>
              ...
              <p className="font-semibold" style={{color: '#1DB954'}}>{method.contact}</p>
            </div>
          ))}
        </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              {faqs.map((faq, index) => (
                <div key={index} className={styles.cardBase}>
                  <h3 className="font-semibold mb-2" style={{color: '#1DB954'}}>{faq.question}</h3>
            ...
            {/* Additional Info */}
            <div className={`${styles.cardBase} mt-6`}>
